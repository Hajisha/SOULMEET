...
class moredetailadmin extends StatelessWidget {
  String name;
  String Gender;
  String Age;
  String caste;
  ...
  moredetailadmin({super.key,required this.name,required this.Gender,
                ...
                children: [SizedBox(height: 30,),
                  Stack(children:[
                    ...
                    InkWell(onTap: () {
                       ...
                       Navigator.pop(context,MaterialPageRoute(builder: (context) => userprofile2(),));
                    },
