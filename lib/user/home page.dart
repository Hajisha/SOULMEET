...
import 'package:matrimony/user/setpreference.dart';
          ...
          child: Column(
            ...
            children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("SOULMEET",style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold)),


              // child: Text("Setpreference",style: TextStyle(color: Colors.blueGrey,fontSize: 18,fontWeight: FontWeight.bold))),
              ]),
